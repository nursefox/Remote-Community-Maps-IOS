...
struct FirebaseAuthProvider: AuthProvider {
    ...
    @MainActor
    func authenticateUser_Email(emailAddress: String, password: String) async throws -> (user: UserAuthInfo, isNewUser: Bool) {
        do {
...
//    @MainActor
//    func authenticateEmailUser() async throws -> (user: UserAuthInfo, isNewUser: Bool) {
//        let helper = SignInWithEmailHelper()
//    }
