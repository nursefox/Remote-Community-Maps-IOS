...
public final class AuthManager: ObservableObject {
    ...
    static let shared: AuthManager = AuthManager(configuration: .firebase)
    ...
    public func signInEmail(emailAddress: String, password: String) async throws -> (user: UserAuthInfo, isNewUser: Bool) {
        let value = try await provider.authenticateUser_Email(emailAddress: emailAddress, password: password)
